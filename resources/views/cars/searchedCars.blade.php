...
@section('content')
    <div class="max-w-screen-xl p-3 mx-auto mt-10 bg-gray-200 rounded-md shadow-xl">
        <form action="">
           <div class="flex justify-center md:flex-row flex-col md:gap-28 gap-4">
                ...
                <div>
                    <button class="w-20 p-2 font-medium text-white rounded-md bg-black hover:bg-gray-800" type="submit">
                        Search</button>
                    <a href={{ route('cars') }}>

                        <button class="w-20 p-2 font-medium text-white rounded-md bg-black hover:bg-gray-800" type="button">
                            All
                        </button>
                    </a>
                </div>
    ...
    <div class="mt-6 mb-2 grid md:grid-cols-3  justify-center items-center mx-auto max-w-screen-xl">
        ...
        @empty
            ...
            <div class="mx-auto max-w-screen-xl h-[300px] items-center ">
                <p class="mx-auto mt-[100px] text-4xl font-medium font-car  ">Empty! </p>
            </div>
            <div class="mx-auto max-w-screen-xl h-[300px] items-center ">
                <p class="mx-auto"></p>
            </div>
