                ...
                <div class="container px-6 mx-auto grid mb-32 ">
                    ...
                    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-3">
                        ...
                        <a href="{{ route('users') }}">
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs hover:bg-pr-200  ">
                                <div class="p-3 mr-4 bg-gray-800 rounded-full ">
                    ...
                    <div class="mt-12">
                        <div class="flex align-middle justify-center">
                            <hr class=" mt-8 h-0.5 w-1/2 bg-gray-800">
                            ...
                            <table class="w-full whitespace-no-wrap overflow-scroll table-auto">
                                <thead>
                                    <tr
                                        ...
                                        <th class="px-4 py-3 w-26">Payment Method</th>
                                    ...
                                    @forelse ($reservations as $reservation)
                                        <tr class="text-gray-700 dark:text-gray-400">
                                            ...
                                            <td class="px-4 py-3 w-36 text-sm flex flex-col justify-center">
                                                ...
                                                <a class="p-2 mb-1 text-white bg-gray-800 hover:bg-pr-400 font-medium rounded text-center"
                                                    href="{{ route('editStatus', ['reservation' => $reservation->id]) }}">
                                                    <button>Edit Status </button>
                                                </a>

                                                <form action="{{ route('reservations.destroy', ['reservation' => $reservation->id]) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="w-full px-4 py-2 text-white bg-indigo-500 hover:bg-indigo-600 font-medium rounded">
                                        Delete
                                    </button>
                                </form>
